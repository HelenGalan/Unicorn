...
{
    public class UnicornDbInitializer
    {
        public static void Seed(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                var _context = serviceScope.ServiceProvider.GetService<UnicornContext>();
                ...
                //}
                {
                    //instanciando os departamentos
                    Department d1 = new Department(1, "Computers");
                    Department d2 = new Department(2, "Electronics");
                    Department d3 = new Department(3, "Fashion");
                    Department d4 = new Department(4, "Books");

                    //instanciando os vendedores
                    ...
                    //O metodo AddRange permite que adicione varios objetos de uma so vez
                    ...
                    //efetivar as alteracoes do banco de dados
                    //salva e confirma
                    _context.SaveChanges();
                }

                /*
                var context = serviceScope.ServiceProvider.GetService<UnicornContext>();
